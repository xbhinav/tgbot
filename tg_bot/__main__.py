            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="🎉 Add me to your group", url="t.me/{}?startgroup=true".format(bot.username)),
                     [InlineKeyboardButton(text="👥 Support Group", url="https://t.me/unitedkeralachat"), InlineKeyboardButton(text="🔔 Update Channel", url="https://t.me/perfect_vazha")],
                     [InlineKeyboardButton(text="Owner ☠️", url="https://t.me/unitedkeralachat"), InlineKeyboardButton(text="🛠 Help", url="https://t.me/{}?start=help".format(bot.username)) ]]))
